...
static const char *SvnPath    = "$HeadURL: svn+ssh://scalamera@svn.code.sf.net/p/tango-cs/code/archiving/hdb++/hdb++es/trunk/src/HdbEventSubscriberClass.cpp $";
...
//
// SVN only:
// $HeadURL: svn+ssh://scalamera@svn.code.sf.net/p/tango-cs/code/archiving/hdb++/hdb++es/trunk/src/HdbEventSubscriberClass.cpp $
//
// CVS only:
